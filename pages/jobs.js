...
const Jobs = () => {
  ...
  return (
    <Layout
      title={"Вакансии | Служба занятости населения Херсонской области"}
      description={
        "вакансии службы занятости населения, центра занятости населения херсонской области, херсона, найти работу"
      }
    >
      <Hero />
