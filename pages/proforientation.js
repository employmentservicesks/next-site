...
import Reasons from "../components/ProfOrientation/Reasons/Reasons"
...
export default function ProfOrientation() {
    ...
    return (
        <Layout
            title={"Профориентация | Служба занятости населения Херсонской области"}
            description={
                "Переробучение на новую профессию в Херсонской области"
            }
        >
            <Hero />
