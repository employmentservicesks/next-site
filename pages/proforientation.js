    ...
    return (
        ...
        >
            ...
            <section className="w-full px-12 py-8 bg-gray-300 mb-24">
                <div className="flex w-full justify-around text-xl items-center">
                    <span className="block">Ознакомьтесь с Постановлениями Правительства РФ о реализации проекта</span>
