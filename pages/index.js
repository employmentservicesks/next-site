...
export default function Home() {
  ...
  return (
    <Layout
      title={"Главная | Служба занятости населения Херсонской области"}
      description={
        "службы занятости населения херсонской области, херсона, работа херсон"
      }
    >
      <Hero />
      <div className="w-full shadow-2xl bg-blue-200 dark:bg-blue-700 text-black dark:text-gray-100 px-8 sm:px-16 py-8 flex justify-center">
        <div className="container">
          ...
          <span className="block text-xl mb-4 text-bold">
            ...
            занятости населения Херсонской области:{" "}
            <a
