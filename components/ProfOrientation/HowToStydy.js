        ...
        <section className="w-full mb-24">
            <div id="how_to" className="w-full md:flex">
                <div className="w-full md:w-1/2 pr-8">
                    ...
                    <span className="block text-xl mb-4">Дополнительную информацию об образовательных программах вы можете получить в управлениях Службы занятости населения Херсонской области или по телефону: +7 990 060 67 73</span>
                </div>
